/**
 * @file PerfectSensorProcessor.cpp
 * @author Beauhowe Zhang <zbohao7@gmail.com>
 * @brief 理想传感器：对方差向量填充常数极小值。
 */
...
PerfectSensorProcessor::PerfectSensorProcessor(rclcpp::Node::SharedPtr node, std::shared_ptr<tf2_ros::Buffer> tf_buffer,
